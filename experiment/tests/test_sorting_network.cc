...
TEST_CASE("SortingNetworkMutator", "[sorting_network]") {
  ...
  // std::cout << "Randomly generating a mate: " << std::endl;
  // network_t mate_network(rand, INPUT_SIZE, MIN_NETWORK_SIZE, MAX_NETWORK_SIZE);
  // mate_network.Print(); std::cout << std::endl;
  // mutator.Crossover1Pt(rand, mutable_network, mate_network);
  // std::cout << "->Child AB: " << std::endl;
  // mutable_network.Print(); std::cout << std::endl;
  // std::cout << "->Child BA: " << std::endl;
  // mate_network.Print(); std::cout << std::endl;
  ...
  std::cout << "==== 2pt crossover ====" << std::endl;
  std::cout << "A: " << std::endl;
  networkA.Print(); std::cout << std::endl;
  std::cout << "B: " << std::endl;
  networkB.Print(); std::cout << std::endl;
  mutator.Crossover2Pt(rand, networkA, networkB);
  std::cout << "->Child ABA: " << std::endl;
  networkA.Print(); std::cout << std::endl;
  std::cout << "->Child BAB: " << std::endl;
  networkB.Print(); std::cout << std::endl;

  // double total_muts = 0;
  // for (size_t i = 0; i < 10000; ++i) {
  //   const size_t num_muts = mutator.Mutate(rand, org.GetGenome());
  //   std::cout << num_muts << std::endl;
  //   total_muts += num_muts;
  // }
  // std::cout << "Total mut (/10000)" << total_muts << std::endl;
...
TEST_CASE("SortingTestMutator", "[sorting_network]") {
  ...
  mutator.MAX_VALUE = 1;
  mutator.MIN_VALUE = 0;
  mutator.PER_SITE_SUB = 0.05;
  mutator.PER_SEQ_INVERSION = 0.1;
  double total_muts = 0;
  for (size_t i = 0; i < 10000; ++i) {
    const size_t num_muts = mutator.Mutate(rand, org.GetGenome());
    std::cout << num_muts << std::endl;
