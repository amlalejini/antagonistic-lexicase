...
EMP_BUILD_CONFIG(ProgramSynthesisConfig, 
  ...
  VALUE(PROG_SELECTION_MODE, size_t, 1, "."),
  VALUE(TEST_SELECTION_MODE, size_t, 1, "."),
  ...
  VALUE(PROG_MUT__PER_BIT_FLIP, double, 0.001, "."),
  VALUE(PROG_MUT__PER_INST_SUB, double, 0.005, "."),
  VALUE(PROG_MUT__PER_INST_INS, double, 0.005, "."),
  VALUE(PROG_MUT__PER_INST_DEL, double, 0.005, "."),
  VALUE(PROG_MUT__PER_PROG_SLIP, double, 0.05, "."),
  VALUE(PROG_MUT__PER_MOD_DUP, double, 0.05, "."),
  VALUE(PROG_MUT__PER_MOD_DEL, double, 0.05, "."),
